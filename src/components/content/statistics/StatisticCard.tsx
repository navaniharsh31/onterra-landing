  ...
  return (
    ...
    >
      ...
      <div className="relative mb-2">
        <div className="text-4xl sm:text-4xl lg:text-5xl  font-light text-slate-900 group-hover:text-navy-600 group-hover:scale-105 transition-all duration-300 tracking-tight text-nowrap">
          {value}
          {suffix && (
