...
const index = selectableStrategies.findIndex((s: any) => s.id === strategy.id);
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16">
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <p className="text-base sm:text-lg text-typography-100 leading-relaxed max-w-4xl mx-auto font-light">
