...
import { FooterSettings, getSocialIcon } from "@/hooks/useFooterContent";
...
const SocialIcons = {
  ...
  newsletter: (props: React.SVGProps<SVGSVGElement>) => (
    ...
    <div className={cn("space-y-4", className)}>
        ...
        {socialMedia.map((social) => {
          ...
          return (
            <a
              ...
              className={cn(
                "group flex items-center justify-center w-10 h-10 rounded-xs",
      ...
      <div className="pt-4 border-t border-slate-800">
        <p className="text-sm text-slate-400 mb-3">
          Stay updated with market insights and investment opportunities.
        </p>
        <a
          href="/newsletter"
          className={cn(
